...
from auth.auth_library import protected_resource
...
class RefreshAPI (MethodView):
    ...
    def refresh_authorized(claims):
        ...
        return make_response(jsonify({
                       ...
                       'access_token' : (User.encode_access_token(claims['sub'])).decode()
                 })), 200
    ...
    def post(self):
        ...
        auth_header = request.headers.get('Authorization')
        return make_response(protected_resource(auth_header, self.refresh_authorized, 'refresh'))
